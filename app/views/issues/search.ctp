...
,			['User.name', '<?php __('User'); ?>']
,			['Issue.status', '<?php __('Status'); ?>']
,			['Issue.created', '<?php __('Created'); ?>']
		]
	}),
	mode: 'local',
...
var issueSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var issueSearchWindow = new Ext.Window({
	title: '<?php __('Search Issue'); ?>',
	modal: true,
	items: issueSearchForm,
	resizable: false,
	width: 550,
	height: 400,
