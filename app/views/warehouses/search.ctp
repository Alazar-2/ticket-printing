...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Warehouse.name', '<?php __('Name'); ?>']
,			['Warehouse.string', '<?php __('String'); ?>']
,			['Warehouse.format', '<?php __('Format'); ?>']
,			['Warehouse.start', '<?php __('Start'); ?>']
,			['Warehouse.end', '<?php __('End'); ?>']
,			['Warehouse.current', '<?php __('Current'); ?>']
,			['Warehouse.status', '<?php __('Status'); ?>']
		]
	}),
	mode: 'local',
...
var warehouseSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var warehouseSearchWindow = new Ext.Window({
	title: '<?php __('Search Warehouse'); ?>',
	modal: true,
	items: warehouseSearchForm,
	resizable: false,
	width: 550,
	height: 400,
