...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Coordinate.x', '<?php __('X'); ?>']
,			['Coordinate.y', '<?php __('Y'); ?>']
,			['Coordinate.length', '<?php __('Length'); ?>']
,			['Coordinate.order', '<?php __('Order'); ?>']
,			['Ticket.name', '<?php __('Ticket'); ?>']
,			['Field.name', '<?php __('Field'); ?>']
,			['Coordinate.alignment', '<?php __('Alignment'); ?>']
		]
	}),
	mode: 'local',
...
var coordinateSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var coordinateSearchWindow = new Ext.Window({
	title: '<?php __('Search Coordinate'); ?>',
	modal: true,
	items: coordinateSearchForm,
	resizable: false,
	width: 550,
	height: 400,
