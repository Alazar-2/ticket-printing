...
var slipSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var slipSearchWindow = new Ext.Window({
	title: '<?php __('Search Slip'); ?>',
	modal: true,
	items: slipSearchForm,
	resizable: false,
	width: 550,
	height: 400,
