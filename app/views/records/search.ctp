...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Issue.name', '<?php __('Issue'); ?>']
,			['Field.name', '<?php __('Field'); ?>']
,			['Record.value', '<?php __('Value'); ?>']
		]
	}),
	mode: 'local',
...
var recordSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var recordSearchWindow = new Ext.Window({
	title: '<?php __('Search Record'); ?>',
	modal: true,
	items: recordSearchForm,
	resizable: false,
	width: 550,
	height: 400,
