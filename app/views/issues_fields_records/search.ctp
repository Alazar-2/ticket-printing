...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['IssuesFieldsRecord.issueId', '<?php __('IssueId'); ?>']
,			['IssuesFieldsRecord.branchid', '<?php __('Branchid'); ?>']
,			['Ticket.name', '<?php __('Ticket'); ?>']
,			['IssuesFieldsRecord.created', '<?php __('Created'); ?>']
,			['IssuesFieldsRecord.fieldId', '<?php __('FieldId'); ?>']
,			['IssuesFieldsRecord.label', '<?php __('Label'); ?>']
,			['IssuesFieldsRecord.type', '<?php __('Type'); ?>']
,			['IssuesFieldsRecord.value', '<?php __('Value'); ?>']
		]
	}),
	mode: 'local',
...
var issuesFieldsRecordSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					issuesFieldsRecordSearchWindow.close();
...
var issuesFieldsRecordSearchWindow = new Ext.Window({
	title: '<?php __('Search IssuesFieldsRecord'); ?>',
	modal: true,
	items: issuesFieldsRecordSearchForm,
	resizable: false,
	width: 550,
	height: 400,
