...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Field.name', '<?php __('Name'); ?>']
,			['Field.label', '<?php __('Label'); ?>']
,			['Field.length', '<?php __('Length'); ?>']
,			['Field.type', '<?php __('Type'); ?>']
,			['Field.data', '<?php __('Data'); ?>']
...
var fieldSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var fieldSearchWindow = new Ext.Window({
	title: '<?php __('Search Field'); ?>',
	modal: true,
	items: fieldSearchForm,
	resizable: false,
	width: 550,
	height: 400,
