...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>
            <?php __('Login to Abay Bank Ticket Printing System'); ?>
        </title>
        <?php
        ...
        <script>
            Ext.onReady(function() {
				...
				if(Ext.isIE ) {
                    var the_message = 'Sorry! Abay Bank Ticket Printing System is not working on Internet Explorer. <br/>';
                ...
                var loginWindow = new Ext.Window({
                    title: 'Login to Abay Bank Ticket Printing System',
                    width: 360,
                    autoHeight: true,
                    layout: 'fit',
                    modal: false,
                    ...
                    loginForm.getForm().submit({
                        ...
                        success: function(f,a){
                            Ext.Msg.show({
                                ...
                                buttons: Ext.MessageBox.OK,
                                msg: 'Welcome to Abay Bank Security Management System',
