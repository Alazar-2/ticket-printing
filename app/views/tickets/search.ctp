...
var ticketSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var ticketSearchWindow = new Ext.Window({
	title: '<?php __('Search Ticket'); ?>',
	modal: true,
	items: ticketSearchForm,
	resizable: false,
	width: 550,
	height: 400,
